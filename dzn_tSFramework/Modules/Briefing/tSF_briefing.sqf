...
TOPIC("VI. Замечания:")
"Взрывчатка находится у Pionier<br />Дополнительные патроны для пулемёта MG3 находятся у Schütze<br />РПГ MAAWS и снаряды к нему находятся в машинах Dingo и вертолётах поддержки"
END
